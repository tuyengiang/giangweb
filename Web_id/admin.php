...
<div id="main">
		...
		<div class="title-title">
			<?php
		      if(isset($_SESSION['user']) && $_SESSION['user']){
		      	  echo "<font color='red' class='b'>".$_SESSION['user']. "</font>";
		      }else{
	...
	<div id="menu-top">
	   <ul><li><a href="create-post.php">Tạo Bài Viết</a></li></ul>
	   <ul><li><a href="create-menu.php">Tạp Chuyên Mục</a></li></ul>
	   <ul><li><a href="menu-login.php">Quản Lý TV</a></li></ul>
	   <ul><li><a href="menu.php">Quản Lý Danh Mục</a></li></ul>
	</div><!--menu-->
	<div id="main-hile">
